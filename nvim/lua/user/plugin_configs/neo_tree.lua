...
-- some commands may take optional config options, see `:h neo-tree-mappings` for details
      ...
      ["X"] = "move", -- takes text input for destination, also accepts the optional config.show_path option like "add".
      ["<C-n>"] = "close_window",
      ["R"] = "refresh",
      ["g?"] = "show_help",
      ["<"] = "prev_source",
...
-- set_keymap('n', '\\', ':Neotree reveal<CR>', { noremap = true, silent = true })
